...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=18&pause=1000&color=A855F7&center=true&vCenter=true&width=750&lines=Building+LLM+systems;RAG+%7C+ReAct+Agents+%7C+Multi-model;React+%2B+Next.js+%2B+FastAPI+%2B+LangChain;CDAC+PG-DAC+Graduate+%7C+Bangalore;Open+to+SDE-1+%2F+AI+Engineer+roles" />
</p>

<br/><br/>

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/abdulrr25/)
[![Gmail](https://img.shields.io/badge/Gmail-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:abdulr6503@gmail.com)
[![Portfolio](https://img.shields.io/badge/Portfolio-6366F1?style=for-the-badge&logo=vercel&logoColor=white)](https://abdulrr25.vercel.app/)
...
- 🤖 &nbsp; Building **AI-powered full-stack apps** — RAG pipelines, ReAct agents, multi-model LLM platforms
- 🎓 &nbsp; **PG-DAC @ C-DAC Pune** · 900 hrs · **Grade A in Project Work**
- 🏛️ &nbsp; **B.Tech CSE** @ ABES Engineering College · 2021–2025
- 💼 &nbsp; Freelance dev — shipped production websites for real clients
- 🏆 &nbsp; **BNB Chainlink Hackathon 2025** — AI legal assistant with on-chain verification
- 🌱 &nbsp; Exploring **LangGraph**, multi-agent systems & fine-tuning
- 📍 &nbsp; **Bangalore** · Open to SDE-1 / Frontend / AI Engineer roles
...
![LanceDB](https://img.shields.io/badge/LanceDB-8B5CF6?style=for-the-badge)
...
![Superfluid](https://img.shields.io/badge/Superfluid-1DB954?style=for-the-badge)
...
> **`FastAPI`** · **`React`** · **`LangChain`** · **`Groq API`** · **`FAISS`** · **`ChromaDB`** · **`Python`** · **`SSE`**

```
Not a GPT wrapper. A full AI infrastructure platform — built piece by piece from scratch.
```

✅ &nbsp; **Multi-model inference** — switch between LLaMA 3.3, Mixtral & Gemma in one UI · real-time SSE streaming
✅ &nbsp; **RAG pipeline** — upload PDFs or URLs → chunked → embedded → FAISS vector search → grounded answers
✅ &nbsp; **ReAct AI Agent** — reasons across 6 live tools: weather · web search · doc retrieval · calculator · datetime · Python REPL
✅ &nbsp; **Production backend** — FastAPI with rate limiting, CORS, clean REST API design
...
### 🎓 TEACHO — Decentralized Online Teaching Platform
#### *Final Year Major Project — B.Tech CSE*

</div>

> **`Next.js`** · **`TypeScript`** · **`Solidity`** · **`Superfluid Protocol`** · **`Tailwind CSS`** · **`Huddle01`**

```
Pay-per-second education — students only pay for time actually spent learning.
```

✅ &nbsp; **Pay-per-second streaming** — Superfluid streams tuition in real time · instructors earn as students watch
✅ &nbsp; **Gig-based marketplace** — instructors list sessions · students purchase per-class, not subscription
✅ &nbsp; **Live video classes** — Huddle01 integration for real-time instructor–student video sessions

<div align="center">

[![View Repo](https://img.shields.io/badge/📁_View_Repo-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/abdulrr25/Major-Project)
...
| 🏛️ | Program | Period | Result |
|:---:|---|:---:|:---:|
| ![CDAC](https://img.shields.io/badge/C--DAC_Pune-6366F1?style=flat-square) | PG Diploma in Advanced Computing (PG-DAC) | Aug 2025 – Feb 2026 | Grade B · **⭐ Grade A in Project** |
| ![ABES](https://img.shields.io/badge/ABES_Engg-A855F7?style=flat-square) | B.Tech — Computer Science & Engineering | 2021 – 2025 | Graduate |
| ![HackerRank](https://img.shields.io/badge/HackerRank-2EC866?style=flat-square&logo=hackerrank&logoColor=white) | JavaScript · Problem Solving · Java · SQL | — | ✅ Certified |
| ![Cisco](https://img.shields.io/badge/Cisco-1BA0D7?style=flat-square&logo=cisco&logoColor=white) | Cybersecurity Essentials | — | ✅ Certified |
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:a855f7,100:6366f1&height=120&section=footer&text=Open%20to%20Work%20%7C%20Let%27s%20Build%20Something&fontSize=20&fontColor=ffffff&animation=fadeIn&fontAlignY=65" width="100%"/>
